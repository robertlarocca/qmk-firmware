...
enum custom_keycodes {
	BSPC_DEL,	// double-tap backspace for delete
...
/*
	MACRO = 3,	// macro layer
	MISC = 4,	// miscellaneous layer
	NAVI = 5,	// navigation layer
	SHIFT = 6,	// shift layer
*/
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[BASE] = LAYOUT_60_tsangan_hhkb(
		...
		KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, TD(BSPC_DEL),
